  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <p className={styles.sectionSubText}>Que pensent-ils de moi ?</p>
          <h3 className={styles.sectionHeadText}>Témoignage</h3>
        </motion.div>
      </div>
      <div
        className={`${styles.paddingX} -mt-18 pb-14 flex flex-wrap gap-7`}
      >
